...
CREATE TABLE `equip_0`(
    ...
    `roleid` bigint DEFAULT 0,
    `snakeid` int DEFAULT 0,
    `equip1` varchar(4096) DEFAULT NULL,
    `equip2` varchar(4096) DEFAULT NULL,
    `equip3` varchar(4096) DEFAULT NULL,
    `equip4` varchar(4096) DEFAULT NULL,
...
CREATE TABLE `food_0`(
    ...
    `roleid` bigint DEFAULT 0,
    `snakeid` int DEFAULT 0,
    `food1` varchar(4096) DEFAULT NULL,
    `food2` varchar(4096) DEFAULT NULL,
    `food3` varchar(4096) DEFAULT NULL,
    `food4` varchar(4096) DEFAULT NULL,
...
CREATE TABLE `mail_0`(
    `version` bigint DEFAULT 0,
    `roleid` bigint DEFAULT 0,
    `mail1` varchar(4096) DEFAULT NULL,
    `mail2` varchar(4096) DEFAULT NULL,
    `mail3` varchar(4096) DEFAULT NULL,
    `mail4` varchar(4096) DEFAULT NULL,
    `mail5` varchar(4096) DEFAULT NULL,
...
CREATE TABLE `material_0`(
    ...
    `roleid` bigint DEFAULT 0,
    `snakeid` int DEFAULT 0,
    `material1` varchar(4096) DEFAULT NULL,
    `material2` varchar(4096) DEFAULT NULL,
    `material3` varchar(4096) DEFAULT NULL,
    `material4` varchar(4096) DEFAULT NULL,
...
CREATE TABLE `skill_0`(
    ...
    `roleid` bigint DEFAULT 0,
    `snakeid` int DEFAULT 0,
    `skill1` varchar(4096) DEFAULT NULL,
    `skill2` varchar(4096) DEFAULT NULL,
    `skill3` varchar(4096) DEFAULT NULL,
    `skill4` varchar(4096) DEFAULT NULL,
...
CREATE TABLE `interaction_0`(
    ...
    `roleid` bigint DEFAULT 0,
    `snakeid` int DEFAULT 0,
    `interaction1` varchar(4096) DEFAULT NULL,
    `interaction2` varchar(4096) DEFAULT NULL,
    `interaction3` varchar(4096) DEFAULT NULL,
    `interaction4` varchar(4096) DEFAULT NULL,
