...
int GORM_SetTableLOGIN_LOGId2Name(OUT FieldId2Name &mapId2Name);
int GORM_SetTableLOGIN_LOGName2Id(OUT FieldName2Id &mapName2Id);
...
int GORM_SetTableRES_LOGId2Name(OUT FieldId2Name &mapId2Name);
int GORM_SetTableRES_LOGName2Id(OUT FieldName2Id &mapName2Id);
...
int GORM_SetTablePTUSERId2Name(OUT FieldId2Name &mapId2Name);
int GORM_SetTablePTUSERName2Id(OUT FieldName2Id &mapName2Id);
int GORM_SetTableUSERId2Name(OUT FieldId2Name &mapId2Name);
int GORM_SetTableUSERName2Id(OUT FieldName2Id &mapName2Id);
int GORM_SetTableMAINLINETASKId2Name(OUT FieldId2Name &mapId2Name);
int GORM_SetTableMAINLINETASKName2Id(OUT FieldName2Id &mapName2Id);
int GORM_SetTablePUBMAILId2Name(OUT FieldId2Name &mapId2Name);
int GORM_SetTablePUBMAILName2Id(OUT FieldName2Id &mapName2Id);
...
int GORM_InitTableSchemaInfo(PB_MSG_PTR pMsgPtr)
{
    ...
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    ...
    if (pInfo == nullptr)
        return GORM_ERROR;
    pInfo->set_version(1);
    pInfo->set_tablename("ptuser");
    pInfo->set_tableidx(16);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    ...
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("rolesdata");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    // for table mainlinetask
    pInfo = pHandShake->add_schemas();
    if (pInfo == nullptr)
        return GORM_ERROR;
    pInfo->set_version(1);
    pInfo->set_tablename("mainlinetask");
    pInfo->set_tableidx(18);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    ...
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask0");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask1");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask2");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask3");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask4");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask5");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask6");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask7");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask8");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
    pColumn->set_name("compleatetask9");
    pColumn->set_typedesc("bytes");
    pColumn->set_type(GORM_PB_COLUMN_TYPE_BYTES);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
    ...
    if (pInfo == nullptr)
        return GORM_ERROR;
    pInfo->set_version(1);
    pInfo->set_tablename("pubmail");
    pInfo->set_tableidx(19);
    pColumn = pInfo->add_columns();
    if (pColumn == nullptr)
        return GORM_ERROR;
    pColumn->set_version(0);
...
uint32 GORM_TableHash(int iTableId, const GORM_PB_TABLE &pbTable)
{
    ...
    {
        if (!pbTable.has_login_log())
            return 0;
        const GORM_PB_Table_login_log& login_log = pbTable.login_log();
        int64 tmp_ROLEID = login_log.roleid();
        char szSrcHash[1024];
        int iTotalLen = GORM_SafeSnprintf(szSrcHash, 1024, "%lld_" , tmp_ROLEID);
        if (iTotalLen > 1024)
            iTotalLen = 1024;
    ...
    {
        if (!pbTable.has_res_log())
            return 0;
        const GORM_PB_Table_res_log& res_log = pbTable.res_log();
        int64 tmp_ROLEID = res_log.roleid();
        char szSrcHash[1024];
        int iTotalLen = GORM_SafeSnprintf(szSrcHash, 1024, "%lld_" , tmp_ROLEID);
        if (iTotalLen > 1024)
            iTotalLen = 1024;
    ...
    {
        if (!pbTable.has_ptuser())
            return 0;
        const GORM_PB_Table_ptuser& ptuser = pbTable.ptuser();
        const string &tmp_PTID = ptuser.ptid();
        int32 tmp_PTTYPE = ptuser.pttype();
        char szSrcHash[1024];
        int iTotalLen = GORM_SafeSnprintf(szSrcHash, 1024, "%s_%d_" , tmp_PTID.c_str(), tmp_PTTYPE);
        if (iTotalLen > 1024)
            iTotalLen = 1024;
        return GORM_Hash::Crc32_1((const char*)szSrcHash, iTotalLen);
    }
    ...
    {
        if (!pbTable.has_mainlinetask())
            return 0;
        const GORM_PB_Table_mainlinetask& mainlinetask = pbTable.mainlinetask();
        int64 tmp_ROLEID = mainlinetask.roleid();
        char szSrcHash[1024];
        int iTotalLen = GORM_SafeSnprintf(szSrcHash, 1024, "%lld_" , tmp_ROLEID);
        if (iTotalLen > 1024)
            iTotalLen = 1024;
    ...
    {
        if (!pbTable.has_pubmail())
            return 0;
        const GORM_PB_Table_pubmail& pubmail = pbTable.pubmail();
        int32 tmp_MAILID = pubmail.mailid();
        char szSrcHash[1024];
        int iTotalLen = GORM_SafeSnprintf(szSrcHash, 1024, "%d_" , tmp_MAILID);
        if (iTotalLen > 1024)
            iTotalLen = 1024;
        return GORM_Hash::Crc32_1((const char*)szSrcHash, iTotalLen);
    }
...
int GetTablePbMsgDefine(int iTableId, PB_MSG_PTR &pMsgPtr)
{
    ...
    case GORM_PB_TABLE_IDX_LOGIN_LOG:
    {
        pMsgPtr = new GORM_PB_Table_login_log();
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_MAIL:
    {
    ...
    case GORM_PB_TABLE_IDX_RES_LOG:
    {
        pMsgPtr = new GORM_PB_Table_res_log();
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_INTERACTION:
    {
    ...
    case GORM_PB_TABLE_IDX_PTUSER:
    {
        pMsgPtr = new GORM_PB_Table_ptuser();
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_USER:
    {
    ...
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        pMsgPtr = new GORM_PB_Table_mainlinetask();
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        pMsgPtr = new GORM_PB_Table_pubmail();
        return GORM_OK;
    }
    }
...
bool GORM_TableHasData(GORM_PB_TABLE *pTable, int iTableId)
{
    ...
    case GORM_PB_TABLE_IDX_PTUSER:
        return pTable->has_ptuser();
    case GORM_PB_TABLE_IDX_USER:
        return pTable->has_user();
    case GORM_PB_TABLE_IDX_MAINLINETASK:
        return pTable->has_mainlinetask();
    case GORM_PB_TABLE_IDX_PUBMAIL:
        return pTable->has_pubmail();
    }
...
int GORM_GetTableSrcPbMsg(int iTableId, GORM_PB_TABLE *pTable, PB_MSG_PTR &pMsgPtr)
{
    ...
    case GORM_PB_TABLE_IDX_LOGIN_LOG:
    {
        pMsgPtr = pTable->mutable_login_log();
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_MAIL:
    {
    ...
    case GORM_PB_TABLE_IDX_RES_LOG:
    {
        pMsgPtr = pTable->mutable_res_log();
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_INTERACTION:
    {
    ...
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        pMsgPtr = pTable->mutable_mainlinetask();
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        pMsgPtr = pTable->mutable_pubmail();
        return GORM_OK;
    }
    }
...
int GORM_AddRecordToReqPbMsgDefine(int iTableId, GORM_PB_TABLE *pPbTable, PB_MSG_PTR pPbMsg)
{
    ...
    case GORM_PB_TABLE_IDX_LOGIN_LOG:
    {
        GORM_PB_Table_login_log *pTableMsg = dynamic_cast<GORM_PB_Table_login_log*>(pPbMsg);
        pPbTable->set_allocated_login_log(pTableMsg);
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_MAIL:
    {
    ...
    case GORM_PB_TABLE_IDX_RES_LOG:
    {
        GORM_PB_Table_res_log *pTableMsg = dynamic_cast<GORM_PB_Table_res_log*>(pPbMsg);
        pPbTable->set_allocated_res_log(pTableMsg);
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_INTERACTION:
    {
    ...
    case GORM_PB_TABLE_IDX_PTUSER:
    {
        GORM_PB_Table_ptuser *pTableMsg = dynamic_cast<GORM_PB_Table_ptuser*>(pPbMsg);
        pPbTable->set_allocated_ptuser(pTableMsg);
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_USER:
    {
    ...
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        GORM_PB_Table_mainlinetask *pTableMsg = dynamic_cast<GORM_PB_Table_mainlinetask*>(pPbMsg);
        pPbTable->set_allocated_mainlinetask(pTableMsg);
        return GORM_OK;
    }
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        GORM_PB_Table_pubmail *pTableMsg = dynamic_cast<GORM_PB_Table_pubmail*>(pPbMsg);
        pPbTable->set_allocated_pubmail(pTableMsg);
        return GORM_OK;
    }
    }
    return GORM_INVALID_TABLE;
...
int GORM_SetTableVersion(OUT TableVersionMap& mapTableVersion)
{
    ...
    mapTableVersion[GORM_PB_TABLE_IDX_LOGIN_LOG] = 1;
    ...
    mapTableVersion[GORM_PB_TABLE_IDX_RES_LOG] = 1;
    ...
    mapTableVersion[GORM_PB_TABLE_IDX_PTUSER] = 1;
    mapTableVersion[GORM_PB_TABLE_IDX_USER] = 1;
    mapTableVersion[GORM_PB_TABLE_IDX_MAINLINETASK] = 1;
    mapTableVersion[GORM_PB_TABLE_IDX_PUBMAIL] = 1;
    return GORM_OK;
}
...
int GORM_SetTableName2Id(OUT TableName2Id &mapName2Id)
{
    ...
    mapName2Id["ptuser"] = GORM_PB_TABLE_IDX_PTUSER;
    mapName2Id["user"] = GORM_PB_TABLE_IDX_USER;
    mapName2Id["mainlinetask"] = GORM_PB_TABLE_IDX_MAINLINETASK;
    mapName2Id["pubmail"] = GORM_PB_TABLE_IDX_PUBMAIL;
    return GORM_OK;
}
...
int GORM_SetTableId2Name(OUT TableId2Name &mapId2Name)
{
    ...
    mapId2Name[GORM_PB_TABLE_IDX_PTUSER] = "ptuser";
    mapId2Name[GORM_PB_TABLE_IDX_USER] = "user";
    mapId2Name[GORM_PB_TABLE_IDX_MAINLINETASK] = "mainlinetask";
    mapId2Name[GORM_PB_TABLE_IDX_PUBMAIL] = "pubmail";
    return GORM_OK;
}
...
int GORM_SetTableFieldId2Name(int iTableType, OUT FieldId2Name &mapId2Name)
{
    ...
    case GORM_PB_TABLE_IDX_LOGIN_LOG:
    {
        return GORM_SetTableLOGIN_LOGId2Name(mapId2Name);
    }
    case GORM_PB_TABLE_IDX_MAIL:
    {
    ...
    case GORM_PB_TABLE_IDX_RES_LOG:
    {
        return GORM_SetTableRES_LOGId2Name(mapId2Name);
    }
    case GORM_PB_TABLE_IDX_INTERACTION:
    {
    ...
    case GORM_PB_TABLE_IDX_PTUSER:
    {
        return GORM_SetTablePTUSERId2Name(mapId2Name);
    }
    case GORM_PB_TABLE_IDX_USER:
    {
    ...
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        return GORM_SetTableMAINLINETASKId2Name(mapId2Name);
    }
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        return GORM_SetTablePUBMAILId2Name(mapId2Name);
    }
    default:
        return GORM_ERROR;
    }
...
int GORM_SetTableFieldName2Id(int iTableType, OUT FieldName2Id &mapName2Id)
{
    ...
    case GORM_PB_TABLE_IDX_LOGIN_LOG:
    {
        return GORM_SetTableLOGIN_LOGName2Id(mapName2Id);
    }
    case GORM_PB_TABLE_IDX_MAIL:
    {
    ...
    case GORM_PB_TABLE_IDX_RES_LOG:
    {
        return GORM_SetTableRES_LOGName2Id(mapName2Id);
    }
    case GORM_PB_TABLE_IDX_INTERACTION:
    {
    ...
    case GORM_PB_TABLE_IDX_PTUSER:
    {
        return GORM_SetTablePTUSERName2Id(mapName2Id);
    }
    case GORM_PB_TABLE_IDX_USER:
    {
    ...
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        return GORM_SetTableMAINLINETASKName2Id(mapName2Id);
    }
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        return GORM_SetTablePUBMAILName2Id(mapName2Id);
    }
    default:
        return GORM_ERROR;
    }
...
int GORM_SetTableHEROId2Name(OUT FieldId2Name &mapId2Name)
{
    ...
    mapId2Name[GORM_PB_FIELD_HERO_TEAMS] = "teams";
    return GORM_OK;
}
int GORM_SetTableLOGIN_LOGId2Name(OUT FieldId2Name &mapId2Name)
{
    mapId2Name[GORM_PB_FIELD_LOGIN_LOG_VERSION] = "version";
    mapId2Name[GORM_PB_FIELD_LOGIN_LOG_ROLEID] = "roleid";
    mapId2Name[GORM_PB_FIELD_LOGIN_LOG_ACTION] = "action";
    mapId2Name[GORM_PB_FIELD_LOGIN_LOG_ONLINE] = "online";
    mapId2Name[GORM_PB_FIELD_LOGIN_LOG_IP] = "ip";
    mapId2Name[GORM_PB_FIELD_LOGIN_LOG_APPID] = "appid";
    mapId2Name[GORM_PB_FIELD_LOGIN_LOG_CREATETIME] = "createtime";
    return GORM_OK;
}
int GORM_SetTableMAILId2Name(OUT FieldId2Name &mapId2Name)
{
...
int GORM_SetTableRES_LOGId2Name(OUT FieldId2Name &mapId2Name)
{
    mapId2Name[GORM_PB_FIELD_RES_LOG_VERSION] = "version";
    mapId2Name[GORM_PB_FIELD_RES_LOG_ROLEID] = "roleid";
    mapId2Name[GORM_PB_FIELD_RES_LOG_ACTION] = "action";
    mapId2Name[GORM_PB_FIELD_RES_LOG_CFGTYPE] = "cfgtype";
    mapId2Name[GORM_PB_FIELD_RES_LOG_CFGID] = "cfgid";
    mapId2Name[GORM_PB_FIELD_RES_LOG_DELTA] = "delta";
    mapId2Name[GORM_PB_FIELD_RES_LOG_VALUE] = "value";
    mapId2Name[GORM_PB_FIELD_RES_LOG_CREATETIME] = "createtime";
    return GORM_OK;
}
int GORM_SetTableINTERACTIONId2Name(OUT FieldId2Name &mapId2Name)
{
...
int GORM_SetTableROLEId2Name(OUT FieldId2Name &mapId2Name)
{
    ...
    mapId2Name[GORM_PB_FIELD_ROLE_WORLDID] = "worldid";
    mapId2Name[GORM_PB_FIELD_ROLE_PTTYPE] = "pttype";
    mapId2Name[GORM_PB_FIELD_ROLE_USERID] = "userid";
    mapId2Name[GORM_PB_FIELD_ROLE_PROCEEDSLV] = "proceedslv";
    return GORM_OK;
}
int GORM_SetTableSCENEId2Name(OUT FieldId2Name &mapId2Name)
{
    ...
    mapId2Name[GORM_PB_FIELD_SCENE_SEASON] = "season";
    return GORM_OK;
}
int GORM_SetTableSKILLId2Name(OUT FieldId2Name &mapId2Name)
{
...
int GORM_SetTablePTUSERId2Name(OUT FieldId2Name &mapId2Name)
{
    mapId2Name[GORM_PB_FIELD_PTUSER_VERSION] = "version";
    mapId2Name[GORM_PB_FIELD_PTUSER_PTID] = "ptid";
    mapId2Name[GORM_PB_FIELD_PTUSER_PTTYPE] = "pttype";
    mapId2Name[GORM_PB_FIELD_PTUSER_USERID] = "userid";
    return GORM_OK;
}
int GORM_SetTableUSERId2Name(OUT FieldId2Name &mapId2Name)
{
    ...
    mapId2Name[GORM_PB_FIELD_USER_ROLESDATA] = "rolesdata";
    return GORM_OK;
}
int GORM_SetTableMAINLINETASKId2Name(OUT FieldId2Name &mapId2Name)
{
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_VERSION] = "version";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_ROLEID] = "roleid";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_RUNNINGTASK] = "runningtask";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK0] = "compleatetask0";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK1] = "compleatetask1";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK2] = "compleatetask2";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK3] = "compleatetask3";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK4] = "compleatetask4";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK5] = "compleatetask5";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK6] = "compleatetask6";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK7] = "compleatetask7";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK8] = "compleatetask8";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK9] = "compleatetask9";
    mapId2Name[GORM_PB_FIELD_MAINLINETASK_UNLOCKFUNCS] = "unlockfuncs";
    return GORM_OK;
}
int GORM_SetTablePUBMAILId2Name(OUT FieldId2Name &mapId2Name)
{
    mapId2Name[GORM_PB_FIELD_PUBMAIL_VERSION] = "version";
    mapId2Name[GORM_PB_FIELD_PUBMAIL_MAILID] = "mailid";
    mapId2Name[GORM_PB_FIELD_PUBMAIL_ADDRESSER] = "addresser";
    mapId2Name[GORM_PB_FIELD_PUBMAIL_TITLE] = "title";
    mapId2Name[GORM_PB_FIELD_PUBMAIL_BODY] = "body";
    mapId2Name[GORM_PB_FIELD_PUBMAIL_ROLES] = "roles";
    mapId2Name[GORM_PB_FIELD_PUBMAIL_ATTACHMENT] = "attachment";
    mapId2Name[GORM_PB_FIELD_PUBMAIL_DT] = "dt";
    mapId2Name[GORM_PB_FIELD_PUBMAIL_DEL] = "del";
    return GORM_OK;
}
int GORM_SetTableCURRENCYName2Id(OUT FieldName2Id &mapName2Id)
{
...
int GORM_SetTableHEROName2Id(OUT FieldName2Id &mapName2Id)
{
    ...
    mapName2Id["teams"] = GORM_PB_FIELD_HERO_TEAMS;
    return GORM_OK;
}
int GORM_SetTableLOGIN_LOGName2Id(OUT FieldName2Id &mapName2Id)
{
    mapName2Id["version"] = GORM_PB_FIELD_LOGIN_LOG_VERSION;
    mapName2Id["roleid"] = GORM_PB_FIELD_LOGIN_LOG_ROLEID;
    mapName2Id["action"] = GORM_PB_FIELD_LOGIN_LOG_ACTION;
    mapName2Id["online"] = GORM_PB_FIELD_LOGIN_LOG_ONLINE;
    mapName2Id["ip"] = GORM_PB_FIELD_LOGIN_LOG_IP;
    mapName2Id["appid"] = GORM_PB_FIELD_LOGIN_LOG_APPID;
    mapName2Id["createtime"] = GORM_PB_FIELD_LOGIN_LOG_CREATETIME;
    return GORM_OK;
}
int GORM_SetTableMAILName2Id(OUT FieldName2Id &mapName2Id)
{
...
int GORM_SetTableRES_LOGName2Id(OUT FieldName2Id &mapName2Id)
{
    mapName2Id["version"] = GORM_PB_FIELD_RES_LOG_VERSION;
    mapName2Id["roleid"] = GORM_PB_FIELD_RES_LOG_ROLEID;
    mapName2Id["action"] = GORM_PB_FIELD_RES_LOG_ACTION;
    mapName2Id["cfgtype"] = GORM_PB_FIELD_RES_LOG_CFGTYPE;
    mapName2Id["cfgid"] = GORM_PB_FIELD_RES_LOG_CFGID;
    mapName2Id["delta"] = GORM_PB_FIELD_RES_LOG_DELTA;
    mapName2Id["value"] = GORM_PB_FIELD_RES_LOG_VALUE;
    mapName2Id["createtime"] = GORM_PB_FIELD_RES_LOG_CREATETIME;
    return GORM_OK;
}
int GORM_SetTableINTERACTIONName2Id(OUT FieldName2Id &mapName2Id)
{
...
int GORM_SetTableROLEName2Id(OUT FieldName2Id &mapName2Id)
{
    ...
    mapName2Id["worldid"] = GORM_PB_FIELD_ROLE_WORLDID;
    mapName2Id["pttype"] = GORM_PB_FIELD_ROLE_PTTYPE;
    mapName2Id["userid"] = GORM_PB_FIELD_ROLE_USERID;
    mapName2Id["proceedslv"] = GORM_PB_FIELD_ROLE_PROCEEDSLV;
    return GORM_OK;
}
int GORM_SetTableSCENEName2Id(OUT FieldName2Id &mapName2Id)
{
    ...
    mapName2Id["season"] = GORM_PB_FIELD_SCENE_SEASON;
    return GORM_OK;
}
int GORM_SetTableSKILLName2Id(OUT FieldName2Id &mapName2Id)
{
...
int GORM_SetTablePTUSERName2Id(OUT FieldName2Id &mapName2Id)
{
    mapName2Id["version"] = GORM_PB_FIELD_PTUSER_VERSION;
    mapName2Id["ptid"] = GORM_PB_FIELD_PTUSER_PTID;
    mapName2Id["pttype"] = GORM_PB_FIELD_PTUSER_PTTYPE;
    mapName2Id["userid"] = GORM_PB_FIELD_PTUSER_USERID;
    return GORM_OK;
}
int GORM_SetTableUSERName2Id(OUT FieldName2Id &mapName2Id)
{
    ...
    mapName2Id["rolesdata"] = GORM_PB_FIELD_USER_ROLESDATA;
    return GORM_OK;
}
int GORM_SetTableMAINLINETASKName2Id(OUT FieldName2Id &mapName2Id)
{
    mapName2Id["version"] = GORM_PB_FIELD_MAINLINETASK_VERSION;
    mapName2Id["roleid"] = GORM_PB_FIELD_MAINLINETASK_ROLEID;
    mapName2Id["runningtask"] = GORM_PB_FIELD_MAINLINETASK_RUNNINGTASK;
    mapName2Id["compleatetask0"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK0;
    mapName2Id["compleatetask1"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK1;
    mapName2Id["compleatetask2"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK2;
    mapName2Id["compleatetask3"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK3;
    mapName2Id["compleatetask4"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK4;
    mapName2Id["compleatetask5"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK5;
    mapName2Id["compleatetask6"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK6;
    mapName2Id["compleatetask7"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK7;
    mapName2Id["compleatetask8"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK8;
    mapName2Id["compleatetask9"] = GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK9;
    mapName2Id["unlockfuncs"] = GORM_PB_FIELD_MAINLINETASK_UNLOCKFUNCS;
    return GORM_OK;
}
int GORM_SetTablePUBMAILName2Id(OUT FieldName2Id &mapName2Id)
{
    mapName2Id["version"] = GORM_PB_FIELD_PUBMAIL_VERSION;
    mapName2Id["mailid"] = GORM_PB_FIELD_PUBMAIL_MAILID;
    mapName2Id["addresser"] = GORM_PB_FIELD_PUBMAIL_ADDRESSER;
    mapName2Id["title"] = GORM_PB_FIELD_PUBMAIL_TITLE;
    mapName2Id["body"] = GORM_PB_FIELD_PUBMAIL_BODY;
    mapName2Id["roles"] = GORM_PB_FIELD_PUBMAIL_ROLES;
    mapName2Id["attachment"] = GORM_PB_FIELD_PUBMAIL_ATTACHMENT;
    mapName2Id["dt"] = GORM_PB_FIELD_PUBMAIL_DT;
    mapName2Id["del"] = GORM_PB_FIELD_PUBMAIL_DEL;
    return GORM_OK;
}
...
{
    vector<string> vColumns = {"version","roleid","snakeid","heros","teams"};
    ...
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        ...
        {"teams", GORM_PB_COLUMN_TYPE_STRING},
    };
    mapTablesColumnInfo["hero"] = mapColumnType;
    return GORM_OK;
}
int GORM_InitTableColumnInfo_login_log(unordered_map<string, vector<string>> &mapTablesColumnOrder, unordered_map<string, unordered_map<string, GORM_PB_COLUMN_TYPE>> &mapTablesColumnInfo)
{
    vector<string> vColumns = {"version","roleid","action","online","ip","appid","createtime"};
    mapTablesColumnOrder["login_log"] = vColumns;
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        {"version", GORM_PB_COLUMN_TYPE_UINT},
        {"roleid", GORM_PB_COLUMN_TYPE_INT},
        {"action", GORM_PB_COLUMN_TYPE_INT},
        {"online", GORM_PB_COLUMN_TYPE_INT},
        {"ip", GORM_PB_COLUMN_TYPE_STRING},
        {"appid", GORM_PB_COLUMN_TYPE_STRING},
        {"createtime", GORM_PB_COLUMN_TYPE_INT},
    };
    mapTablesColumnInfo["login_log"] = mapColumnType;
    return GORM_OK;
}
...
int GORM_InitTableColumnInfo_res_log(unordered_map<string, vector<string>> &mapTablesColumnOrder, unordered_map<string, unordered_map<string, GORM_PB_COLUMN_TYPE>> &mapTablesColumnInfo)
{
    vector<string> vColumns = {"version","roleid","action","cfgtype","cfgid","delta","value","createtime"};
    mapTablesColumnOrder["res_log"] = vColumns;
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        {"version", GORM_PB_COLUMN_TYPE_UINT},
        {"roleid", GORM_PB_COLUMN_TYPE_INT},
        {"action", GORM_PB_COLUMN_TYPE_INT},
        {"cfgtype", GORM_PB_COLUMN_TYPE_INT},
        {"cfgid", GORM_PB_COLUMN_TYPE_INT},
        {"delta", GORM_PB_COLUMN_TYPE_INT},
        {"value", GORM_PB_COLUMN_TYPE_INT},
        {"createtime", GORM_PB_COLUMN_TYPE_INT},
    };
    mapTablesColumnInfo["res_log"] = mapColumnType;
    return GORM_OK;
}
...
{
    vector<string> vColumns = {"version","roleid","rolename","level","exp","characterid","gold","offlinetime","inited","createtime","face","online","worldid","pttype","userid","proceedslv"};
    ...
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        ...
        {"userid", GORM_PB_COLUMN_TYPE_INT},
        {"proceedslv", GORM_PB_COLUMN_TYPE_INT},
    };
...
{
    vector<string> vColumns = {"version","roleid","sceneid","collects","season"};
    ...
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        ...
        {"season", GORM_PB_COLUMN_TYPE_STRING},
    };
...
int GORM_InitTableColumnInfo_ptuser(unordered_map<string, vector<string>> &mapTablesColumnOrder, unordered_map<string, unordered_map<string, GORM_PB_COLUMN_TYPE>> &mapTablesColumnInfo)
{
    vector<string> vColumns = {"version","ptid","pttype","userid"};
    mapTablesColumnOrder["ptuser"] = vColumns;
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        {"version", GORM_PB_COLUMN_TYPE_UINT},
    ...
    mapTablesColumnInfo["ptuser"] = mapColumnType;
    return GORM_OK;
}
...
{
    vector<string> vColumns = {"version","userid","ptid","pttype","createtime","rolesdata"};
    ...
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        ...
        {"pttype", GORM_PB_COLUMN_TYPE_INT},
        {"createtime", GORM_PB_COLUMN_TYPE_INT},
        {"rolesdata", GORM_PB_COLUMN_TYPE_STRING},
    };
    mapTablesColumnInfo["user"] = mapColumnType;
    return GORM_OK;
}
int GORM_InitTableColumnInfo_mainlinetask(unordered_map<string, vector<string>> &mapTablesColumnOrder, unordered_map<string, unordered_map<string, GORM_PB_COLUMN_TYPE>> &mapTablesColumnInfo)
{
    vector<string> vColumns = {"version","roleid","runningtask","compleatetask0","compleatetask1","compleatetask2","compleatetask3","compleatetask4","compleatetask5","compleatetask6","compleatetask7","compleatetask8","compleatetask9","unlockfuncs"};
    mapTablesColumnOrder["mainlinetask"] = vColumns;
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        {"version", GORM_PB_COLUMN_TYPE_UINT},
        {"roleid", GORM_PB_COLUMN_TYPE_INT},
        {"runningtask", GORM_PB_COLUMN_TYPE_INT},
        {"compleatetask0", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask1", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask2", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask3", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask4", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask5", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask6", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask7", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask8", GORM_PB_COLUMN_TYPE_STRING},
        {"compleatetask9", GORM_PB_COLUMN_TYPE_STRING},
        {"unlockfuncs", GORM_PB_COLUMN_TYPE_STRING},
    };
    mapTablesColumnInfo["mainlinetask"] = mapColumnType;
    return GORM_OK;
}
int GORM_InitTableColumnInfo_pubmail(unordered_map<string, vector<string>> &mapTablesColumnOrder, unordered_map<string, unordered_map<string, GORM_PB_COLUMN_TYPE>> &mapTablesColumnInfo)
{
    vector<string> vColumns = {"version","mailid","addresser","title","body","roles","attachment","dt","del"};
    mapTablesColumnOrder["pubmail"] = vColumns;
    unordered_map<string, GORM_PB_COLUMN_TYPE> mapColumnType = {
        {"version", GORM_PB_COLUMN_TYPE_UINT},
        {"mailid", GORM_PB_COLUMN_TYPE_INT},
        {"addresser", GORM_PB_COLUMN_TYPE_STRING},
        {"title", GORM_PB_COLUMN_TYPE_STRING},
        {"body", GORM_PB_COLUMN_TYPE_STRING},
        {"roles", GORM_PB_COLUMN_TYPE_STRING},
        {"attachment", GORM_PB_COLUMN_TYPE_STRING},
        {"dt", GORM_PB_COLUMN_TYPE_INT},
        {"del", GORM_PB_COLUMN_TYPE_INT},
    };
    mapTablesColumnInfo["pubmail"] = mapColumnType;
    return GORM_OK;
}
int GORM_InitTableColumnInfo(unordered_map<string, vector<string>> &mapTablesColumnOrder, unordered_map<string, unordered_map<string, GORM_PB_COLUMN_TYPE>> &mapTablesColumnInfo)
{
    ...
    if (GORM_InitTableColumnInfo_hero(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    if (GORM_InitTableColumnInfo_login_log(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    ...
    if (GORM_InitTableColumnInfo_npc(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    if (GORM_InitTableColumnInfo_res_log(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    ...
    if (GORM_InitTableColumnInfo_skill(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    if (GORM_InitTableColumnInfo_ptuser(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    if (GORM_InitTableColumnInfo_user(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    if (GORM_InitTableColumnInfo_mainlinetask(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    if (GORM_InitTableColumnInfo_pubmail(mapTablesColumnOrder, mapTablesColumnInfo))
        return GORM_ERROR;
    return GORM_OK;
}
void GORM_SetTableFieldValue(PB_MSG_PTR pMsg, int iTableId, int iFieldId, const char * value, const size_t size)
{
    ...
    case GORM_PB_TABLE_IDX_HERO:
    {
        ...
        {
            GORM_PB_Table_hero* pPbReal = dynamic_cast<GORM_PB_Table_hero*>(pMsg);
            return pPbReal->set_teams((const char*)value, size);
        }
        }
    }
    case GORM_PB_TABLE_IDX_LOGIN_LOG:
    {
        ...
        {
            GORM_PB_Table_login_log* pPbReal = dynamic_cast<GORM_PB_Table_login_log*>(pMsg);
            return pPbReal->set_ip((const char*)value, size);
        }
        case GORM_PB_FIELD_LOGIN_LOG_APPID:
        {
            GORM_PB_Table_login_log* pPbReal = dynamic_cast<GORM_PB_Table_login_log*>(pMsg);
            return pPbReal->set_appid((const char*)value, size);
        }
        }
    }
    case GORM_PB_TABLE_IDX_MAIL:
    ...
    case GORM_PB_TABLE_IDX_SCENE:
    {
        ...
        {
            GORM_PB_Table_scene* pPbReal = dynamic_cast<GORM_PB_Table_scene*>(pMsg);
            return pPbReal->set_season((const char*)value, size);
        }
        }
    }
    case GORM_PB_TABLE_IDX_SKILL:
    ...
    case GORM_PB_TABLE_IDX_PTUSER:
    {
        ...
        {
            GORM_PB_Table_ptuser* pPbReal = dynamic_cast<GORM_PB_Table_ptuser*>(pMsg);
    ...
    case GORM_PB_TABLE_IDX_USER:
    {
        ...
        {
            GORM_PB_Table_user* pPbReal = dynamic_cast<GORM_PB_Table_user*>(pMsg);
            return pPbReal->set_rolesdata((const char*)value, size);
        }
        }
    }
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask0((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK1:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask1((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK2:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask2((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK3:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask3((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK4:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask4((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK5:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask5((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK6:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask6((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK7:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask7((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK8:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask8((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK9:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask9((const char*)value, size);
        }
        case GORM_PB_FIELD_MAINLINETASK_UNLOCKFUNCS:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_unlockfuncs((const char*)value, size);
        }
        }
    }
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        ...
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_addresser((const char*)value, size);
        }
        case GORM_PB_FIELD_PUBMAIL_TITLE:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_title((const char*)value, size);
        }
        case GORM_PB_FIELD_PUBMAIL_BODY:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_body((const char*)value, size);
        }
        case GORM_PB_FIELD_PUBMAIL_ROLES:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_roles((const char*)value, size);
        }
        case GORM_PB_FIELD_PUBMAIL_ATTACHMENT:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_attachment((const char*)value, size);
        }
        }
    }
    }
...
void GORM_SetTableFieldValue(PB_MSG_PTR pMsg, int iTableId, int iFieldId, const char * value)
{
    ...
    case GORM_PB_TABLE_IDX_HERO:
    {
        ...
        {
            GORM_PB_Table_hero* pPbReal = dynamic_cast<GORM_PB_Table_hero*>(pMsg);
            return pPbReal->set_teams((const char*)value);
        }
        }
    }
    case GORM_PB_TABLE_IDX_LOGIN_LOG:
    {
        ...
        {
            GORM_PB_Table_login_log* pPbReal = dynamic_cast<GORM_PB_Table_login_log*>(pMsg);
            return pPbReal->set_ip((const char*)value);
        }
        case GORM_PB_FIELD_LOGIN_LOG_APPID:
        {
            GORM_PB_Table_login_log* pPbReal = dynamic_cast<GORM_PB_Table_login_log*>(pMsg);
            return pPbReal->set_appid((const char*)value);
        }
        }
    }
    case GORM_PB_TABLE_IDX_MAIL:
    ...
    case GORM_PB_TABLE_IDX_SCENE:
    {
        ...
        {
            GORM_PB_Table_scene* pPbReal = dynamic_cast<GORM_PB_Table_scene*>(pMsg);
            return pPbReal->set_season((const char*)value);
        }
        }
    }
    case GORM_PB_TABLE_IDX_SKILL:
    ...
    case GORM_PB_TABLE_IDX_USER:
    {
        ...
        {
            GORM_PB_Table_user* pPbReal = dynamic_cast<GORM_PB_Table_user*>(pMsg);
            return pPbReal->set_rolesdata((const char*)value);
        }
        }
    }
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask0((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK1:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask1((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK2:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask2((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK3:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask3((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK4:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask4((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK5:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask5((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK6:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask6((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK7:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask7((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK8:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask8((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK9:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_compleatetask9((const char*)value);
        }
        case GORM_PB_FIELD_MAINLINETASK_UNLOCKFUNCS:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_unlockfuncs((const char*)value);
        }
        }
    }
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        ...
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_addresser((const char*)value);
        }
        case GORM_PB_FIELD_PUBMAIL_TITLE:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_title((const char*)value);
        }
        case GORM_PB_FIELD_PUBMAIL_BODY:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_body((const char*)value);
        }
        case GORM_PB_FIELD_PUBMAIL_ROLES:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_roles((const char*)value);
        }
        case GORM_PB_FIELD_PUBMAIL_ATTACHMENT:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_attachment((const char*)value);
        }
        }
    }
    }
...
void GORM_SetTableFieldValue(PB_MSG_PTR pMsg, int iTableId, int iFieldId, int8 value)
{
    ...
    case GORM_PB_TABLE_IDX_LOGIN_LOG:
    {
        ...
        {
            GORM_PB_Table_login_log* pPbReal = dynamic_cast<GORM_PB_Table_login_log*>(pMsg);
            return pPbReal->set_action(value);
        }
    ...
    case GORM_PB_TABLE_IDX_RES_LOG:
    {
        ...
        {
            GORM_PB_Table_res_log* pPbReal = dynamic_cast<GORM_PB_Table_res_log*>(pMsg);
            return pPbReal->set_version(value);
        }
        ...
        {
            GORM_PB_Table_res_log* pPbReal = dynamic_cast<GORM_PB_Table_res_log*>(pMsg);
            return pPbReal->set_cfgtype(value);
        }
        case GORM_PB_FIELD_RES_LOG_CFGID:
        {
            GORM_PB_Table_res_log* pPbReal = dynamic_cast<GORM_PB_Table_res_log*>(pMsg);
            return pPbReal->set_cfgid(value);
        }
        case GORM_PB_FIELD_RES_LOG_DELTA:
        {
            GORM_PB_Table_res_log* pPbReal = dynamic_cast<GORM_PB_Table_res_log*>(pMsg);
            return pPbReal->set_delta(value);
        }
        case GORM_PB_FIELD_RES_LOG_VALUE:
        {
            GORM_PB_Table_res_log* pPbReal = dynamic_cast<GORM_PB_Table_res_log*>(pMsg);
            return pPbReal->set_value(value);
        }
    ...
    case GORM_PB_TABLE_IDX_ROLE:
    {
        ...
        {
            GORM_PB_Table_role* pPbReal = dynamic_cast<GORM_PB_Table_role*>(pMsg);
            return pPbReal->set_proceedslv(value);
        }
        }
    }
    case GORM_PB_TABLE_IDX_SCENE:
    ...
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            return pPbReal->set_runningtask(value);
        }
        }
    }
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        ...
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_mailid(value);
        }
        case GORM_PB_FIELD_PUBMAIL_DT:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_dt(value);
        }
        case GORM_PB_FIELD_PUBMAIL_DEL:
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            return pPbReal->set_del(value);
        }
        }
    }
    }
...
int GORM_GetTableFieldValue(PB_MSG_PTR pMsg, int iTableId, int iFieldId, string &value)
{
    ...
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask0();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK1:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask1();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK2:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask2();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK3:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask3();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK4:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask4();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK5:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask5();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK6:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask6();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK7:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask7();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK8:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask8();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_COMPLEATETASK9:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->compleatetask9();
            return GORM_OK;
        }
        case GORM_PB_FIELD_MAINLINETASK_UNLOCKFUNCS:
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            value = pPbReal->unlockfuncs();
            return GORM_OK;
        }
        }
    }
...
int GORM_GetTableFieldValue(PB_MSG_PTR pMsg, int iTableId, int iFieldId, uint8 *&value, size_t &size)
{
    ...
    case GORM_PB_TABLE_IDX_SCENE:
    {
        ...
        {
            GORM_PB_Table_scene* pPbReal = dynamic_cast<GORM_PB_Table_scene*>(pMsg);
            string strValue = pPbReal->season();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
    ...
    case GORM_PB_TABLE_IDX_USER:
    {
        ...
        {
            GORM_PB_Table_user* pPbReal = dynamic_cast<GORM_PB_Table_user*>(pMsg);
            string strValue = pPbReal->rolesdata();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
    ...
    case GORM_PB_TABLE_IDX_MAINLINETASK:
    {
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask0();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask1();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask2();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask3();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask4();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask5();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask6();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask7();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask8();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->compleatetask9();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_mainlinetask* pPbReal = dynamic_cast<GORM_PB_Table_mainlinetask*>(pMsg);
            string strValue = pPbReal->unlockfuncs();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
    ...
    case GORM_PB_TABLE_IDX_PUBMAIL:
    {
        ...
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            string strValue = pPbReal->addresser();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
        ...
        {
            GORM_PB_Table_pubmail* pPbReal = dynamic_cast<GORM_PB_Table_pubmail*>(pMsg);
            string strValue = pPbReal->attachment();
            value=(uint8*)strValue.c_str();
            size=strValue.size();
            return GORM_OK;
        }
