...
{ "CR_CONN_HOST_ERROR", 2003, "Can't connect to MySQL server on '%-.100s' (%d)", 0, 0, 0},
...
{ "CR_COMPRESSION_NOT_SUPPORTED", 2065, "Compression protocol not supported with asynchronous protocol", 0, 0, 0},
