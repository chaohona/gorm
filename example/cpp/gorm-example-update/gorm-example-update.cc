...
int TestUpdate() 
{
    ...
    pRequest->SetCheckDataVersionPolicy(CHECKDATAVERSION_AUTOINCREASE);
...
int main()
{
    ...
    for(;;)
    {
        ...
        if (pResponse != nullptr)
        {
            ...
            pResultRecord->GetFieldValue(gorm::GORM_PB_ACCOUNT_FIELD_INDEX::GORM_PB_FIELD_ACCOUNT_DESC, strAccountAccField);
